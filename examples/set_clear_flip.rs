...
fn main() {
    // set with with copy
    println!(
        "original {:b}, after set {:b}",
        UberByte::MIN,
        UberByte::MIN.set(FIFTH_BIT_MASK)
    );
    ...
    // clear with copy
    println!(
        "Original {:b}, after clear {:b}",
        UberByte::MAX,
        UberByte::MAX.clear(FIFTH_BIT_MASK)
    );
    ...
    // flip with copy
    println!(
        "Original {:b}, after flip {:b}",
        UberByte::from(42),
        UberByte::from(42).flip()
    );
